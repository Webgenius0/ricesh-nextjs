  ...
  return (
    <section>
      <div className="container grid grid-cols-4 gap-6 py-10">
        <CountUpComponent value={500} label="Projects Completed" duration={3} />
        <CountUpComponent value={350} label="Courses resitered" duration={3} />
        <CountUpComponent value={50} label="Courses in progress" duration={3} />
        <CountUpComponent
          value={2}
